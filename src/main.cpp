...
int main(void) {
    ...
    }
    {
        ...
        try {
            sb.m_vertex_src = readFileToString("res/shaders/vertex_normalmap.glsl");
            sb.m_fragment_src = readFileToString("res/shaders/fragment_normalmap.glsl");
        ...
        Texture tex{"res/textures/brickwall.jpg", ""};
        Texture normalTex{"res/textures/brickwall_normal.jpg", ""};
